...
public class DocUtil {
    ...
    public static void download(HttpServletRequest request, HttpServletResponse response, String toWordName , String newWordName, Map dataMap)  {

        String path = ClassUtils.getDefaultClassLoader().getResource("").getPath();
        XWPFTemplate template = XWPFTemplate.compile(path+"static/docx/"+toWordName).render(dataMap);
