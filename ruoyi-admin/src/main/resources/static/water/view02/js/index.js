            ...
            series : [
                {
                    name:'地表温度',
                    type:'bar',
                    data:[8, 11, 14, 10, 20, 18, 15, 26, 27, 24, 25, 36],
                    markPoint : {
                        data : [
                            {type : 'max', name: '最大值'},
                            {type : 'min', name: '最小值'}
                ...
                },
                {
                    name:'气温',
                    type:'bar',
                    data:[25, 8, 13, 25, 30, 29, 18, 15, 19, 24, 27, 34],
                    markPoint : {
                        data : [
                            {name : '月最高', value : 34, xAxis: 12, yAxis: 34, symbolSize:18},
                            {name : '月最低', value : 8, xAxis: 2, yAxis: 8}
                        ]
                    },
                    markLine : {
                        data : [
