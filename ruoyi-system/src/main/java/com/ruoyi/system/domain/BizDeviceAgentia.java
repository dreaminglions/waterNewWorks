...
public class BizDeviceAgentia extends BaseEntity
{
    ...
    /** 药剂类型 */
    private String agentiaType; //4：设备
    /** 药剂分类 */
    ...
    public Long getAgentiaDevice() {
        return agentiaDevice;
    }

    public void setAgentiaDevice(Long agentiaDevice) {
        this.agentiaDevice = agentiaDevice;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("agentiaDevice", getAgentiaDevice())
